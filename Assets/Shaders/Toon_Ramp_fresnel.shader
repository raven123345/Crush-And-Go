Shader "Raven/Toon_Ramp_fresnel"
{
    Properties
    {
        ...
        _FresnelTransparency("Fresnel Transparency", range(0,1)) = 0.8
        _FresnelCoverage("Fresnel Coverage", range(0,1)) = 0.5
    ...
    SubShader
    {
        ...
        fixed _FresnelTransparency;
        fixed _FresnelCoverage;
        fixed _FresnelStep;
        ...
        //diffuse light
            ...
            fixed fresnel = 1 - dot(viewDir, s.Normal);
            fixed4 fresnelClip =lerp(0, smoothstep(_FresnelCoverage * 0.9, _FresnelCoverage, fresnel) * _FresnelColor, _FresnelTransparency);
        ...
        //combinning
            fixed4 color;
            color.rgb = s.Albedo * _LightColor0 * _lightClip + specClip + fresnelClip;
            color.a= s.Alpha;
