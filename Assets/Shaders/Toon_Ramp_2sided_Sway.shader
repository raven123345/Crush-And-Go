Shader "Raven/Toon_Ramp_2sided_Sway"
{
    Properties
    {
        ...
        _Displacement("Displacement", Range(-1,1)) = 1
        _DisplacementFreq("Displacement Freq", float) = 1
    }
    SubShader
    {
    ...
    #pragma surface surf Toon vertex:vert addshadow
        ...
        void vert(inout appdata_full v)
        {
           v.normal *=-1; 
            ...
            v.vertex.z +=  (v.texcoord.x-1) * (sin(_Time *_DisplacementFreq)*_Displacement);
            v.vertex.y +=  (v.texcoord.x-1) * (sin(_Time *_DisplacementFreq*2)*_Displacement*0.1);
		}
